    ...
    <section className="about-section" id="APropos">
      <div className="about-container">
        <div className="about-content">
          ...
          <p>
            Actuellement étudiant en 2ème année de BUT Informatique à l'IUT de Bordeaux Gardignan, 
          ...
          <p>
            ...
            J'aime particulièrement travailler sur l'expérience utilisateur, cherchant toujours à 
